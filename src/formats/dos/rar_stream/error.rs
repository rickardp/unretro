...
impl From<crate::formats::dos::rar_stream::decompress::DecompressError> for RarError {
    fn from(e: crate::formats::dos::rar_stream::decompress::DecompressError) -> Self {
        match e {
            crate::formats::dos::rar_stream::decompress::DecompressError::UnsupportedMethod(m) => {
                Self::DecompressionNotSupported(m)
            }
